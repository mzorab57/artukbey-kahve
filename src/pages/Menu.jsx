...
const Menu = () => {
  ...
  const allMenuItems = [
    ...
    },
    {
      ...
      // {
      //   imgSrc: Columbia_Filtre_Coffee_250gr,
      ...
      {
        imgSrc: Artukbey_Kayisili_Dibek_Coffee_Kese_200gr,
        altText: "Kayisili Dibek Coffee",
        title: t("kayisili_dibek_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Damla_Sakizli_Dibek_Coffee_100gr,
        altText: "Damla Sakizli Dibek Coffee",
        title: t("damla_sakizli_dibek_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Suryani_Dibek_Coffee_Kese_200gr,
        altText: "Suryani Dibek Coffee",
        title: t("suryani_dibek_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Menengic_Coffee_kese_200gr,
        altText: "Menengic Coffee",
        title: t("menengic_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Kakuleli_Dibek_Coffee_Kese,
        altText: "Kakuleli Dibek Coffee",
        title: t("kakuleli_dibek_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Special_Dibek_Coffee_Kese_100gr,
        altText: "Special Dibek Coffee",
        title: t("special_dibek_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Sade_Dibek_Turkish_Coffee_Kese,
        altText: "Sade Dibek Turkish Coffee",
        title: t("sade_dibek_turkish_coffee"),
        description: t("coffee"),
        price: "........... 8,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_7_Si_1_Arada_Dibek_Coffee_300gr,
        altText: "7 in 1 Arada Dibek Coffee",
        title: t("7_in_1_arada_dibek_coffee"),
        description: t("coffee"),
        price: "........... 13,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      },
      {
        imgSrc: Srtukbey_Kakuleli_Dibek_Coffee_400gr,
        altText: "Kakuleli Dibek Coffee",
        title: t("kakuleli_dibek_coffee_400gr"),
        description: t("coffee"),
        price: "........... 10,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Findikli_Dibek_Coffee_300gr,
        altText: "Findikli Dibek Coffee",
        title: t("findikli_dibek_coffee"),
        description: t("coffee"),
        price: "........... 7,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Damla_Sakizli_Turk_Coffee_400gr,
        altText: "Damla Sakizli Turk Coffee",
        title: t("damla_sakizli_turk_coffee"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Bitter_Cikolatali_Dibek_Coffee_400gr,
        altText: "Bitter Chocolate Dibek Coffee",
        title: t("bitter_chocolate_dibek_coffee"),
        description: t("coffee"),
        price: "........... 4,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: Artukbey_Sade_Dibek_Turk_Coffee_300gr,
        altText: "Sade Dibek Turk Coffee",
        title: t("sade_dibek_turk_coffee"),
        description: t("coffee"),
        price: "........... 4,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: artukbey_antep_fistikli_dibek_kahvesi,
        altText: "Antep Fistikli Dibek Coffee",
        title: t("antep_fistikli_dibek_coffee"),
        description: t("coffee"),
        price: "........... 4,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      },
      {
        imgSrc: special_damla_sakizli_dibek_kahvesi_300gr,
        altText: "Damla Sakizli Dibek Coffee",
        title: t("damla_sakizli_dibek_coffee_300gr"),
        description: t("coffee"),
        price: "........... 9,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      },
      {
        imgSrc: artukbey_suryani_dibek_kahvesi_400gr,
        altText: "Suryani Dibek Coffee",
        title: t("suryani_dibek_coffee_400gr"),
        description: t("coffee"),
        price: "........... 6,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      },
      {
        imgSrc: special_damlasakizli_dibek_kahvesi_ten,
        altText: "Damla Sakizli Dibek Coffee",
        title: t("damla_sakizli_dibek_coffee_ten"),
        description: t("coffee"),
        price: "........... 8,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: damlasakizli_turk_kahvesi_teneke_kutu,
        altText: "Damla Sakizli Turkish Coffee",
        title: t("damla_sakizli_turk_coffee_teneke_kutu"),
        description: t("coffee"),
        price: "........... 15,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      {
        imgSrc: artukbeydibek_7_kahve_3_bitki_special,
        altText: "7 Kahve 3 Bitki Special",
        title: t("7_kahve_3_bitki_special"),
        description: t("coffee"),
        price: "........... 15,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
      ...
      // },
      {
        imgSrc: artukbey_special_damla_sakizli_dibek,
        altText: "Special Damla Sakizli Dibek Coffee",
        title: t("special_damla_sakizli_dibek"),
        description: t("coffee"),
        price: "........... 15,000 IQD",
        category: t("hot_drink"),
        type: t("pawder_coffee")
  ...
  const filteredMenuItems = allMenuItems.filter(item => {
    ...
    if (activeCategory === t("cold_drink") && activeSubcategory !== t("all_drink")) {
      return item.category === activeCategory && item.type === activeSubcategory;
    }
